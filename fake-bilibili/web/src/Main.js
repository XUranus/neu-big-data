  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <AppBar position="static">
          <Toolbar>
            ...
            <Typography className={classes.title} variant="h6" color="inherit" noWrap>
             <a href="/" style={{textDecoration:'none',color:'white'}}>Bilibili</a>
            </Typography>
        ...
        {renderMobileMenu}
        <BrowserRouter>
            <Route path="/av/:name" component={VideoPlaySection}/>
